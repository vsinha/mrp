...
type InventoryRepository interface {
	GetInventoryLots(partNumber entities.PartNumber, location string) ([]*entities.InventoryLot, error)
	GetSerializedInventory(partNumber entities.PartNumber, location string) ([]*entities.SerializedInventory, error)
	...
	AllocateInventory(partNumber entities.PartNumber, location string, quantity entities.Quantity) (*entities.AllocationResult, error)
}
