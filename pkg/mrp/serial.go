...
func (sc *SerialComparator) IsSerialInRange(targetSerial string, effectivity SerialEffectivity) bool {
...
func (sc *SerialComparator) ResolveSerialEffectivity(targetSerial string, bomLines []BOMLine) []BOMLine {
	var effective []BOMLine
...
func (sc *SerialComparator) ValidateSerialEffectivity(bomLines []BOMLine) error {
	// Group by parent/child combination
	effectivityMap := make(map[string][]SerialEffectivity)
...
func (sc *SerialComparator) checkOverlaps(effectivities []SerialEffectivity) error {
...
func (sc *SerialComparator) rangesOverlap(range1, range2 SerialEffectivity) bool {
